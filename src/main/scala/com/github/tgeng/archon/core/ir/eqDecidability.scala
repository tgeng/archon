...
/**
 * A type is reifiable if the equality of its inhabitants can be efficiently determined at runtime.
 * That is, a type is not reifiable if its inhabitants
 ...
 *
 * The primary purpose of this type is to limit what types are allowed as args to effects. Efficient
 * methods of deciding equality is needed for runtime handler resolution.
 *
